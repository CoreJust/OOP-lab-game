...
void ContinuousEffect::applyTo(Entity& entity, World& world) {
	switch (m_id) {
		case EffectId::ACCELERATION: entity.getStatsMut().speed *= Effect::EFFECT_BASE_PER_LEVEL * m_level; break;
		case EffectId::DECCELERATION: entity.getStatsMut().speed /= Effect::EFFECT_BASE_PER_LEVEL * m_level; break;
		case EffectId::HEALTH_INCREASE: entity.getStatsMut().maxHealth *= Effect::EFFECT_BASE_PER_LEVEL * m_level; break;
		case EffectId::HEALTH_DECREASE: entity.getStatsMut().maxHealth /= Effect::EFFECT_BASE_PER_LEVEL * m_level; break;
		case EffectId::POWER_INCREASE: entity.getStatsMut().power *= Effect::EFFECT_BASE_PER_LEVEL * m_level; break;
		case EffectId::POWER_DECREASE: entity.getStatsMut().power /= Effect::EFFECT_BASE_PER_LEVEL * m_level; break;
		case EffectId::DEFENCE_INCREASE: entity.getStatsMut().defence *= Effect::EFFECT_BASE_PER_LEVEL * m_level; break;
		case EffectId::DEFENCE_DECREASE: entity.getStatsMut().defence /= Effect::EFFECT_BASE_PER_LEVEL * m_level; break;
